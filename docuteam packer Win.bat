...
start	javaw -Djava.library.path=lib -Dfile.encoding=utf-8 -Dlog4j.configurationFile=config/log4j2.xml -Djava.util.logging.manager=org.apache.logging.log4j.jul.LogManager -Xms512M -Xmx2048M -cp config\;.\;docuteam-packer-5.4.0.jar ch.docuteam.packer.gui.launcher.LauncherView
